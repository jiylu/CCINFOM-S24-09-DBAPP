...
public class TechnicianTicketQueue extends JPanel {
    ...
    private void initTitle() {
        titleLabel = new JLabel("Current Ticket Queue");
    ...
    private void initTable() {
        // Define columns
        String[] columnNames = {"Ticket Id", "Subject", "Category ID", "Employee ID", "Technician ID", "Creation Date", "Status"};
